...
#include "../RORI-Interface/Circle.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Circle_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 48, 5),
QT_MOC_LITERAL(8, 54, 9)
    },
    "Circle\0setNumber\0\0i\0setTitre\0newTitle\0"
    "setColor1\0color\0setColor2\0"
};
...
void Circle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setTitre((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->setColor1((*reinterpret_cast< QString(*)>(_a[1]))); break;
...
const QMetaObject Circle::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Circle.data,
      qt_meta_data_Circle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Circle.stringdata))
