...
#include "../onivox_shark/autosaver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_AutoSaver_t, stringdata) + ofs \
...
const QMetaObject AutoSaver::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AutoSaver.data,
      qt_meta_data_AutoSaver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AutoSaver.stringdata))
