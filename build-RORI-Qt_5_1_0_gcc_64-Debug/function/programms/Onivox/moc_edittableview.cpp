...
#include "../onivox_shark/edittableview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_EditTableView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 25, 9)
    ...
    "EditTableView\0removeOne\0\0removeAll\0"
};
...
const QMetaObject EditTableView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_EditTableView.data,
      qt_meta_data_EditTableView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditTableView.stringdata))
