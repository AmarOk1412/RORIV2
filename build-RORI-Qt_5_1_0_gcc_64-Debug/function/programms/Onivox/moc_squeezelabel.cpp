...
#include "../onivox_shark/squeezelabel.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SqueezeLabel_t, stringdata) + ofs \
...
const QMetaObject SqueezeLabel::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_SqueezeLabel.data,
      qt_meta_data_SqueezeLabel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SqueezeLabel.stringdata))
